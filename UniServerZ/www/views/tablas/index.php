...
<div class="row">
  <div class="col-lg-10 col-lg-offset-1">
    <div class="table-responsive col-lg-12">
      <table  id="Tabla" class="table table-hover" data-toggle="table" data-url="<?php echo URL; ?>help/listarColumnas/<?php echo $this->sujeto; ?>" data-search='true' cellspacing="0" width="100%"  >
        <thead>
          <tr>
