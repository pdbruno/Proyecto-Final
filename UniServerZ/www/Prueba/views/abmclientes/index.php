        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="ModalSel">
          <div class="modal-dialog" role="document" >
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default" id="CerrarSelect" >Cancelar</button>
            ...
            <div class="modal-body" >
              ...
              <button type="button" id="BtnAceptar" data-dismiss="modal" class="btn btn-success hidden">Aceptar</button>
